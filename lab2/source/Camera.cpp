...
void Camera::UpdateCameraVectors(glm::vec3 character_rotation)
{
    ...
    //         ķ         ת           ϵ  
    glm::mat4 rotate_matrix = glm::rotate(glm::mat4(1.0f), glm::radians(character_rotation.y), glm::vec3(0.0f, 1.0f, 0.0f));
    tmp_forward = glm::vec3(rotate_matrix * glm::vec4(tmp_forward, 0.0f));
